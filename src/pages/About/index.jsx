    ...
    <div className='container'>
      <section className='info-section'>
        <div className='info-container'>
          ...
          <p className='subtitle'>Full-stack user management system built for Course 5 at Hyper Island</p>
          ...
          <div className='info-footer'>
            <p>
              Made by <strong>Patricia Gea</strong> — <strong>Hyper Island, Stockholm</strong>
            </p>
            ...
            <Link to='/' className='social-link'>← Back to App</Link>
          </div>
        </div>
      </section>
    </div>
